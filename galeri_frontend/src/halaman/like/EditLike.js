...
function EditLike() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8000/api/like/${like_id}/edit`).then((res) => {
      console.log(res);
  ...
  const updateLike = (e) => {
    ...
    axios
      .put(`http://localhost:8000/api/like/${like_id}/edit`, data)
      .then((res) => {
                ...
                <form onSubmit={updateLike}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className="form-control"
                    />
                    <span className="text-danger">{inputErrorList.tanggal_like}</span>
                  </div>
                  <div className="mb-3">
